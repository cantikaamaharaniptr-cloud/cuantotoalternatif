...
const D = {
  ...
  amphtml: 'cuantotoalternatif.com',
};
...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>CUANTOTO | Situs Alternatif Terpercaya: Arena Penakluk Tantangan</title>
        <meta name="description" content="CUANTOTO adalah situs resmi terpercaya dengan akses login cepat, keamanan SSL 256-bit, dan dukungan 24/7. Daftar gratis sekarang." />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href={D.logo} />
        <link rel="canonical" href={'https://' + D.domain + '/'} />
        <link rel="amphtml" href={'https://' + D.domain + '/amp/'} />
        <meta property="og:title" content="CUANTOTO | Situs Alternatif Terpercaya: Arena Penakluk Tantangan" />
        <meta property="og:description" content="CUANTOTO adalah situs resmi terpercaya dengan akses login cepat, keamanan SSL 256-bit, dan dukungan 24/7. Daftar gratis sekarang." />
        <meta property="og:image" content={D.logo} />
        <meta property="og:url" content={'https://' + D.domain} />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:title" content="CUANTOTO | Situs Alternatif Terpercaya: Arena Penakluk Tantangan" />
        <meta name="twitter:description" content="CUANTOTO adalah situs resmi terpercaya dengan akses login cepat, keamanan SSL 256-bit, dan dukungan 24/7. Daftar gratis sekarang." />
      ...
      <style jsx global>{`
        *{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
        body{font-family:'Plus Jakarta Sans',sans-serif;background:#0a1020;color:#e0e0e0;line-height:1.7;overflow-x:hidden}
        a{color:inherit;text-decoration:none}img{max-width:100%;display:block}
        .W{max-width:1200px;margin:0 auto;padding:0 24px}

        .topbar{background:#101830;border-bottom:1px solid rgba(96,165,250,.2);padding:8px 0;font-size:12px;color:#ccc}
        .topbar-inner{display:flex;justify-content:space-between;align-items:center}
        .topbar a{color:#60a5fa;font-weight:600;transition:.2s}.topbar a:hover{opacity:.8}

        header{background:#101830;border-bottom:1px solid rgba(96,165,250,.2);position:sticky;top:0;z-index:50;backdrop-filter:blur(12px)}
        .hd{display:flex;align-items:center;justify-content:space-between;padding:14px 0;gap:16px}
        .logo{display:flex;align-items:center;gap:10px;font-weight:800;font-size:22px;color:#60a5fa;flex-shrink:0}
        .logo img{width:36px;height:36px;border-radius:50%;border:2px solid #60a5fa}
        ...
        .nav-links a:hover,.nav-links a.act{color:#60a5fa;background:rgba(96,165,250,.12)}
        ...
        .btn-p{background:#60a5fa;color:#0a1020}.btn-p:hover{background:#3b82f6;transform:translateY(-1px)}
        .btn-o{border:1.5px solid rgba(96,165,250,.2);color:#60a5fa;background:transparent}.btn-o:hover{background:rgba(96,165,250,.12)}

        .hero{padding:56px 0;position:relative;overflow:hidden}
        .hero::before{content:'';position:absolute;right:-120px;top:-120px;width:500px;height:500px;border-radius:50%;background:rgba(96,165,250,.12)}
        .hero::after{content:'';position:absolute;left:-80px;bottom:-100px;width:350px;height:350px;border-radius:50%;background:rgba(96,165,250,.12)}
        .hero-flex{display:flex;align-items:center;gap:48px;position:relative;z-index:1}
        .hero-text{flex:1}
        .hero-text .tag{display:inline-flex;align-items:center;gap:8px;background:rgba(96,165,250,.12);border:1px solid rgba(96,165,250,.2);padding:6px 18px;border-radius:24px;font-size:12px;font-weight:600;color:#60a5fa;margin-bottom:18px}
        .hero-text .tag .dot{width:8px;height:8px;border-radius:50%;background:#60a5fa;animation:blink 1.5s infinite}
        ...
        .hero-text .btn-hero.primary{background:#60a5fa;color:#0a1020}
        .hero-text .btn-hero.primary:hover{background:#3b82f6;transform:translateY(-2px);box-shadow:0 8px 24px rgba(0,0,0,.3)}
        .hero-text .btn-hero.ghost{background:rgba(96,165,250,.12);color:#60a5fa;border:1.5px solid rgba(96,165,250,.2)}
        .hero-text .btn-hero.ghost:hover{background:#182240}
        .trust-bar{display:flex;gap:22px;margin-top:20px;font-size:12px;color:#bbb}
        .hero-img{flex-shrink:0;width:380px}
        .hero-img img{border-radius:20px;box-shadow:0 24px 64px rgba(0,0,0,.4);border:1px solid rgba(96,165,250,.2)}

        .stats{background:#101830;border-top:1px solid rgba(96,165,250,.2);border-bottom:1px solid rgba(96,165,250,.2);padding:24px 0}
        .stats-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:16px;text-align:center}
        .stat-item{padding:10px 0}
        .stat-item .sv{font-size:28px;font-weight:800;color:#60a5fa}
        .stat-item .sl{font-size:10px;color:#bbb;text-transform:uppercase;letter-spacing:1.5px;margin-top:2px}

        .sec{padding:56px 0}
        .sec-alt{background:#101830}
        .sec-head{text-align:center;margin-bottom:40px}
        .sec-head .pill{display:inline-block;background:rgba(96,165,250,.12);color:#60a5fa;padding:6px 20px;border-radius:24px;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:1px;margin-bottom:12px;border:1px solid rgba(96,165,250,.2)}
        ...
        .art-content h3{font-size:22px;font-weight:700;margin-bottom:18px;color:#60a5fa}
        ...
        .art-gallery img{border-radius:14px;border:1px solid rgba(96,165,250,.2);width:100%;height:210px;object-fit:cover;transition:.3s}
        .art-gallery img:hover{border-color:#60a5fa;transform:scale(1.02)}
        .art-tags{display:flex;gap:8px;flex-wrap:wrap;margin-top:16px}
        .art-tag{background:rgba(96,165,250,.12);color:#60a5fa;padding:6px 16px;border-radius:24px;font-size:11px;font-weight:600;border:1px solid rgba(96,165,250,.2)}

        .feat-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:16px}
        .feat-card{background:#182240;border:1px solid rgba(96,165,250,.2);border-radius:18px;padding:28px;transition:.3s}
        .feat-card:hover{border-color:#60a5fa;transform:translateY(-4px);box-shadow:0 12px 32px rgba(0,0,0,.2)}
        .feat-card .fi-icon{width:50px;height:50px;border-radius:14px;background:rgba(96,165,250,.12);display:flex;align-items:center;justify-content:center;font-size:22px;margin-bottom:16px}
        ...
        .cta-box{background:linear-gradient(135deg,#3b82f6,#60a5fa);border-radius:24px;padding:56px 36px;text-align:center;color:#fff;position:relative;overflow:hidden}
        ...
        .cta-box .btn-cta{background:#fff;color:#0a1020;font-weight:700;padding:16px 36px;border-radius:28px;border:none;cursor:pointer;font-family:inherit;font-size:16px;transition:.25s}
        ...
        .bnr-card{border-radius:16px;overflow:hidden;border:1px solid rgba(96,165,250,.2);transition:.3s}
        .bnr-card:hover{transform:translateY(-3px);box-shadow:0 10px 28px rgba(0,0,0,.2);border-color:#60a5fa}
        .bnr-card img{width:100%;height:auto}

        .faq-list{max-width:740px;margin:0 auto}
        .faq-item{background:#182240;border:1px solid rgba(96,165,250,.2);border-radius:16px;padding:20px 24px;margin-bottom:10px;cursor:pointer;transition:.2s}
        ...
        .faq-q span{color:#60a5fa;font-size:20px;font-weight:700}
        .faq-a{margin-top:12px;color:#bbb;font-size:14px;line-height:1.75;border-top:1px solid rgba(96,165,250,.2);padding-top:12px;text-align:justify}

        footer{background:#101830;border-top:1px solid rgba(96,165,250,.2);padding:40px 0;font-size:13px}
        .ft-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:30px;margin-bottom:24px}
        .ft-col h4{color:#60a5fa;font-size:15px;margin-bottom:14px}
        .ft-col a{display:block;color:#aaa;margin-bottom:8px;transition:.2s}.ft-col a:hover{color:#60a5fa}
        .ft-bottom{border-top:1px solid rgba(96,165,250,.2);padding-top:20px;text-align:center;color:#999}
        ...
        <section className="hero"><div className="W">
          <div className="hero-flex">
            <div className="hero-text">
              ...
              <h1>CUANTOTO | Situs Alternatif Terpercaya: Arena Penakluk Tantangan</h1>
              <p>CUANTOTO adalah situs resmi terpercaya dengan akses login cepat, keamanan SSL 256-bit, dan dukungan 24/7. Daftar gratis sekarang.</p>
              <div className="hbtns">
        ...
        <section className="sec sec-alt" id="tentang"><div className="W">
          ...
          <div className="art-row">
            <div className="art-content">
              ...
              <p>CUANTOTO di situs resmi CUANTOTO adalah arena digital ultimate dengan performa yang tidak tertandingi. Layaknya game dengan grafis terbaik, platform CUANTOTO menghadirkan pengalaman akses yang smooth dan immersive. Server berperforma tinggi memastikan zero lag, sementara sistem keamanan berlapis menjadi shield yang melindungi setiap data dan akun pengguna.</p>
              <div className="art-gallery">
              ...
              <p>Level up pengalaman digital Anda bersama CUANTOTO melalui situs resmi CUANTOTO. Dengan power-up berupa enkripsi SSL 256-bit, uptime 99,9%, dan multiple link alternatif aktif, Anda siap menaklukkan setiap tantangan akses. Tim support 24/7 adalah party member yang selalu siap membantu, memastikan quest Anda menuju platform CUANTOTO selalu berhasil dengan perfect score.</p>
